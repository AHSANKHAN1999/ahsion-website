      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-3 pt-2">
              <a href={contact?.facebook || "#"} target="_blank" className="bg-blue-800 p-2 rounded-lg hover:bg-yellow-400 hover:text-blue-900 transition duration-300">
                <Facebook size={18} />
              </a>
              <a href="#" className="bg-blue-800 p-2 rounded-lg hover:bg-yellow-400 hover:text-blue-900 transition duration-300">
                <Instagram size={18} />
              </a>
              <a href="#" className="bg-blue-800 p-2 rounded-lg hover:bg-yellow-400 hover:text-blue-900 transition duration-300">
                <Linkedin size={18} />
          ...
          {/* 2. Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-6 border-b border-blue-700 pb-2 inline-block text-yellow-400">
              Quick Links
            </h4>
            <ul className="space-y-3">
              {siteData.navigation.map((item) => (
                <li key={item.label}>
                  <Link
                    href={item.link}
                    className="text-blue-100 hover:text-yellow-400 hover:translate-x-1 transition-all duration-300 inline-block text-sm"
                  >
                    › {item.label}
                  </Link>
                </li>
            ...
            <div className="space-y-4 text-sm text-blue-100">
              <div className="flex items-start gap-3 group">
                ...
                <span className="leading-relaxed">
                    {contact?.address || "Sector 5-B, Plot # 106-108, Main Hub River Road, Karachi."}
                </span>
              </div>
              ...
              <div className="flex items-center gap-3 group">
                ...
                <a href={`mailto:${contact?.email}`} className="hover:text-white transition">
                  {contact?.email || "ahsion.edu.pk@gmail.com"}
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-blue-800 pt-8 mt-8 flex justify-center items-center text-xs md:text-sm text-blue-300">
          <p className="text-center">
             © {currentYear} {siteData.site.name}. All Rights Reserved.
          </p>
        </div>
