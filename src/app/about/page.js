  ...
  return (
    <div className="bg-white text-gray-900 font-sans">
      ...
      <div className="bg-blue-900 text-white py-20 px-4 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 font-serif">About AHSION</h1>
      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Maine height fix kar di hai taake image poori nazar aaye */}
          <div className="relative h-[400px] md:h-[500px] w-full rounded-xl overflow-hidden shadow-2xl border-4 border-gray-100">
            <Image
                src="/images/about-main.jpg"  // Make sure ye image public/images folder mein ho
                alt="Campus Building"
                fill
      ...
      {/* ================= MISSION & VISION (Original Dark Blue Cards) ================= */}
      <section className="bg-blue-900 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          
          {/* Mission Card */}
          <div className="bg-white/10 p-8 md:p-10 rounded-xl backdrop-blur-sm border border-white/10 shadow-lg hover:bg-white/20 transition duration-300">
          ...
          <div className="bg-white/10 p-8 md:p-10 rounded-xl backdrop-blur-sm border border-white/10 shadow-lg hover:bg-white/20 transition duration-300">
            ...
            <p className="text-blue-50 leading-relaxed text-justify text-sm md:text-base">
              As a institute, our vision is to produce competent nurses and health care providers whose care, discoveries, authentic and qualified voices may proved them the vital organ of a living society. Our society will start acknowledging their services.
              <br /><br />
              We also wish to create nursing in medical awareness into every home in Pakistan. Finally, we will be able to eradicate the minor diseases by improving health & quality care through excellence in nursing education, research & discoveries.
            </p>
          </div>
